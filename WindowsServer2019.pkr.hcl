...
variable iso_filename_vmware_tools {
  ...
  # https://packages.vmware.com/tools/esx/7.0p01/windows/VMware-tools-windows-11.1.1-16303738.iso
  default = "VMware-tools-windows-11.1.1-16303738.iso"
}
...
variable vm_name {
  ...
  default = "template-windows-server-2019-dc"
}
